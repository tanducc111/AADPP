...
type ClientCompanyBreadcrumb = {
  label: string;
  href?: string;
};

type ClientCompanyBreadcrumbsProps = {
  breadcrumbs: ClientCompanyBreadcrumb[];
};

export function ClientCompanyBreadcrumbs({ breadcrumbs }: ClientCompanyBreadcrumbsProps) {
  return (
